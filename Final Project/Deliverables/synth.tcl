...
analyze -format vhdl ../vhdl/SingleRegister.vhd
analyze -format vhdl ../vhdl/16bitRegFile.vhd
...
create_clock -name CLK -period 3.5 -waveform {0 1.75} {clk}
...
#set_max_delay 20  -from [all_inputs]
